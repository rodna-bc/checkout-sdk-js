...
### [1.52.2-alpha.bc8261a314ffc4cec892d48cfd830dd04b5d0a99](https://github.com/bigcommerce/checkout-sdk-js/compare/v1.8.0...v1.52.2-alpha.bc8261a314ffc4cec892d48cfd830dd04b5d0a99) (2020-02-19)
...
* **common:** CHECKOUT-3462 Bump `@bigcommerce/data-store` version ([e3ac1c2](https://github.com/bigcommerce/checkout-sdk-js/commit/e3ac1c2))
...
* **billing:** CHECKOUT-2933 Convert billing tests to TS ([b5b9582](https://github.com/bigcommerce/checkout-sdk-js/commit/b5b9582))
* **checkout-button:** CHECKOUT-3747 Fix checkout button import path ([f640aaf](https://github.com/bigcommerce/checkout-sdk-js/commit/f640aaf))
* **checkout-button:** CHECKOUT-3747 Group checkout button strategies in folders ([27441c8](https://github.com/bigcommerce/checkout-sdk-js/commit/27441c8))
* **checkout-button:** CHECKOUT-3791 Convert checkout button strategy into interface ([a44ea2f](https://github.com/bigcommerce/checkout-sdk-js/commit/a44ea2f))
* **checkout-button:** CHECKOUT-3791 Move checkout button strategy exports ([15bf2b9](https://github.com/bigcommerce/checkout-sdk-js/commit/15bf2b9))
* **common:** CHECKOUT-2900 Remove no-non-null-assertion TSLint override ([48b9b28](https://github.com/bigcommerce/checkout-sdk-js/commit/48b9b28))
* **common:** CHECKOUT-2900 Remove no-reference TSLint override ([f096518](https://github.com/bigcommerce/checkout-sdk-js/commit/f096518))
* **common:** CHECKOUT-2900 Remove no-unnecessary-type-assertion TSLint override ([2410866](https://github.com/bigcommerce/checkout-sdk-js/commit/2410866))
* **common:** CHECKOUT-2900 Remove no-unused-variable TSLint override ([a7da9eb](https://github.com/bigcommerce/checkout-sdk-js/commit/a7da9eb))
* **common:** CHECKOUT-2900 Remove prefer-method-signature TSLint override ([5f94d95](https://github.com/bigcommerce/checkout-sdk-js/commit/5f94d95))
* **common:** CHECKOUT-2900 Upgrade TSLint config ([fe047f0](https://github.com/bigcommerce/checkout-sdk-js/commit/fe047f0))
* **common:** CHECKOUT-2934 Convert error tests to typescript ([04a8911](https://github.com/bigcommerce/checkout-sdk-js/commit/04a8911))
* **common:** CHECKOUT-2934 Convert geography tests to TypeScript ([70b6848](https://github.com/bigcommerce/checkout-sdk-js/commit/70b6848))
* **common:** CHECKOUT-2934 Convert remote-checkout module to TypeScript ([5701778](https://github.com/bigcommerce/checkout-sdk-js/commit/5701778))
* **common:** CHECKOUT-2934 Convert to typescript all remaining js files ([0221377](https://github.com/bigcommerce/checkout-sdk-js/commit/0221377))
* **common:** CHECKOUT-2934 Convert utility tests to TS ([e41164e](https://github.com/bigcommerce/checkout-sdk-js/commit/e41164e))
* **common:** CHECKOUT-3787 Move bundle files into `bundles` folder ([50a2afe](https://github.com/bigcommerce/checkout-sdk-js/commit/50a2afe))
* **common:** CHECKOUT-4149 Upgrade `request-sender` version ([14f7417](https://github.com/bigcommerce/checkout-sdk-js/commit/14f7417))
...
* **common:** CHECKOUT-4272 Add custom selector creator that automatically memorizes return value of combiner if it returns new function ([00e391c](https://github.com/bigcommerce/checkout-sdk-js/commit/00e391c))
* **common:** CHECKOUT-4272 Add memoize function ([1cf1f3b](https://github.com/bigcommerce/checkout-sdk-js/commit/1cf1f3b))
* **common:** CHECKOUT-4272 Check to make sure there are no unused locals and parameters ([7b15162](https://github.com/bigcommerce/checkout-sdk-js/commit/7b15162))
* **common:** CHECKOUT-4272 Use bigcommerce/memoize package ([b37b397](https://github.com/bigcommerce/checkout-sdk-js/commit/b37b397))
...
* **common:** INT-1500 Move `AmountTransformer` to common folder ([77917f5](https://github.com/bigcommerce/checkout-sdk-js/commit/77917f5))
* **embedded-checkout:** CHECKOUT-3941 Hide content of host page when performing initial redirect ([10de0a4](https://github.com/bigcommerce/checkout-sdk-js/commit/10de0a4))
* **embedded-checkout:** CHECKOUT-3941 Only perform redirect if not already done so recently ([fc12d20](https://github.com/bigcommerce/checkout-sdk-js/commit/fc12d20))
* **order:** CHECKOUT-2934 Convert order tests into TypeScript ([aec54e4](https://github.com/bigcommerce/checkout-sdk-js/commit/aec54e4))
* **payment:** CHECKOUT-2934 Add `code` to CouponErrorResponse ([3d3e521](https://github.com/bigcommerce/checkout-sdk-js/commit/3d3e521))
* **payment:** CHECKOUT-2934 Convert payment instrument tests to TypeScript ([b5305e8](https://github.com/bigcommerce/checkout-sdk-js/commit/b5305e8))
* **payment:** CHECKOUT-3714 Convert payment strategies to enum ([4c2e04b](https://github.com/bigcommerce/checkout-sdk-js/commit/4c2e04b))
* **payment:** CHECKOUT-3791 Convert payment strategy into interface ([4857589](https://github.com/bigcommerce/checkout-sdk-js/commit/4857589))
* **payment:** CHECKOUT-3791 Move payment strategy options interface ([63f0dd8](https://github.com/bigcommerce/checkout-sdk-js/commit/63f0dd8))
* **payment:** CHECKOUT-3954 Rename method that redirects shoppers to Afterpay ([1d3823d](https://github.com/bigcommerce/checkout-sdk-js/commit/1d3823d))
...
* **shipping:** CHECKOUT-2933 Convert shipping tests to TypeScript ([28068b3](https://github.com/bigcommerce/checkout-sdk-js/commit/28068b3))
* **shipping:** CHECKOUT-3791 Convert shipping strategy into interface ([672454c](https://github.com/bigcommerce/checkout-sdk-js/commit/672454c))
* **shipping:** CHECKOUT-3791 Move shipping strategy options interface ([90a06fd](https://github.com/bigcommerce/checkout-sdk-js/commit/90a06fd))
* **shopper:** CHECKOUT-3791 Convert customer strategy into interface ([72a19b9](https://github.com/bigcommerce/checkout-sdk-js/commit/72a19b9))
* **shopper:** CHECKOUT-3791 Move customer strategy options interface ([f56b66b](https://github.com/bigcommerce/checkout-sdk-js/commit/f56b66b))
...
* **checkout:** INT-1434 Creating klarnav2 strategy to support multi-option ([6eb8874](https://github.com/bigcommerce/checkout-sdk-js/commit/6eb8874))
* **checkout:** INT-1434 unit testing ([bc8261a](https://github.com/bigcommerce/checkout-sdk-js/commit/bc8261a))
